...
export const environment = {
    ...
    urlApiAccountTransaction:
        'https://arquitectura-1sa89r3l.uc.gateway.dev/api/v1/transactions',

    urlApiLoan: 'https://arquitectura-1sa89r3l.uc.gateway.dev/api/v2/loans',
    urlApiLoanProduct:
        'https://arquitectura-1sa89r3l.uc.gateway.dev/api/v1/loanProduct',
    urlApiLoanAmortization:
        'https://arquitectura-1sa89r3l.uc.gateway.dev/api/v1/amortization',
    urlApiLoanRepayment:
        'https://arquitectura-1sa89r3l.uc.gateway.dev/api/v1/repayment',
